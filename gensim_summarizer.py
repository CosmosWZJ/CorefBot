...
def summarize_corpus(corpus, num):
...
# Select a number of sentences, or select sentences with a certain length
def summarize(text, num, word_count=None, split=False):
    ...
    most_important_docs = summarize_corpus(corpus, num)
